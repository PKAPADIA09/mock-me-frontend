/*
  ...
  - Added the required column `user_id` to the `interviews` table without a default value. This is not possible if the table is not empty.

*/
-- DropForeignKey
ALTER TABLE "public"."interviews" DROP CONSTRAINT "interviews_userId_fkey";

-- AlterTable
ALTER TABLE "public"."interviews" DROP COLUMN "userId",
